 ...
 ***************************
 ...
 Example for setSensorFunction method
 ************************************
 ...
 .setSensorFunction allows to compute sensors value instead of only reading pin value
 .setSensorFunction takes two parameters: a sensorID (a String), and a custom function (a pointer to a function)
...
void setup() {
  ...
  board.setSensorFunction( "tmp36", convertToCelsius ); // set a custom function for "tmp36" sensor
